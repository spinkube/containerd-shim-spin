...
```bash
k3d cluster create wasm-cluster --image ghcr.io/spinkube/containerd-shim-spin/k3d:v0.17.0 -p "8081:80@loadbalancer" --agents 2 --registry-create mycluster-registry:12345
```
